...
module.exports = {
  ...
  overrides: [
    ...
    },
    {
      ...
      rules: {
        ...
        "no-unused-expressions": "off",
        "no-unused-vars": "off",
        "dylanjs/no-cjs-exports": "off",
        "dylanjs/no-ts-export-equal": "off",
  ...
  rules: {
    ...
    // dylanjs
    "dylanjs/no-import-node-modules-by-path": "error",
    "dylanjs/if-newline": "error",
    "dylanjs/import-dedupe": "error",
    "dylanjs/top-level-function": "error",
    // 'dylanjs/prefer-inline-type-import': 'error',
  },
}
